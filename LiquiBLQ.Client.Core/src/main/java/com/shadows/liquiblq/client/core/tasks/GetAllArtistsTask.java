 ...
 * @author John
 */
public class GetAllArtistsTask extends RunnableTask<JSONResponse> {
    private final String ApiUrl;
    private final UUID SessinKey;
    private final Integer UserId;

    public GetAllArtistsTask(String ApiUrl, UUID SessinKey, Integer UserId) {
        this.ApiUrl = ApiUrl;
    ...
    protected JSONResponse doRoutine() throws Exception {
        return RequestsManager.doGetAllArtistsRequest(ApiUrl, SessinKey, UserId);
    }
