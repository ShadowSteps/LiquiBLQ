 ...
 * @author John
 */
public class GetAlbumsOfSongTask extends RunnableTask<JSONResponse> {
    private final String ApiUrl;
    private final UUID SessinKey;
    private final UUID Id;
    private final Integer UserId;

    public GetAlbumsOfSongTask(String ApiUrl, UUID SessinKey, Integer UserId, UUID Id) {
        this.ApiUrl = ApiUrl;
    ...
    protected JSONResponse doRoutine() throws Exception {
        return RequestsManager.doGetAlbumsOfSongRequest(ApiUrl, SessinKey, UserId, Id);
    }
