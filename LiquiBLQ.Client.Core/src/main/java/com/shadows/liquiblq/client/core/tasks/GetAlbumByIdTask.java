 ...
 * @author John
 */
public class GetAlbumByIdTask extends RunnableTask<JSONResponse> {
    private final String ApiUrl;
    private final UUID SessinKey;
    private final UUID Id;
    private final Integer UserId;

    public GetAlbumByIdTask(String ApiUrl, UUID SessinKey, Integer UserId, UUID Id) {
        this.ApiUrl = ApiUrl;
    ...
    protected JSONResponse doRoutine() throws Exception {
        return RequestsManager.doGetAlbumByIdRequest(ApiUrl, SessinKey, UserId, Id);
    }
