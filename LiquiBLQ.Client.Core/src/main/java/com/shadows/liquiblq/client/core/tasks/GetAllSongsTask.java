 ...
 * @author John
 */
public class GetAllSongsTask extends RunnableTask<JSONResponse> {
    private final String ApiUrl;
    private final UUID SessinKey;
    private final Integer UserId;

    public GetAllSongsTask(String ApiUrl, UUID SessinKey, Integer UserId) {
        this.ApiUrl = ApiUrl;
    ...
    protected JSONResponse doRoutine() throws Exception {
        return RequestsManager.doGetAllSongsRequest(ApiUrl, SessinKey, UserId);
    }
