 ...
 * @author John
 */
public class GetArtistByIdTask extends RunnableTask<JSONResponse> {
    private final String ApiUrl;
    private final UUID SessinKey;
    private final UUID Id;
    private final Integer UserId;

    public GetArtistByIdTask(String ApiUrl, UUID SessinKey, Integer UserId, UUID Id) {
        this.ApiUrl = ApiUrl;
    ...
    protected JSONResponse doRoutine() throws Exception {
        return RequestsManager.doGetArtistByIdRequest(ApiUrl, SessinKey, UserId, Id);
    }
