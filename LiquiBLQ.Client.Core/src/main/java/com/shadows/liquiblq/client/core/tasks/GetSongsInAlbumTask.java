 ...
 * @author John
 */
public class GetSongsInAlbumTask extends RunnableTask<JSONResponse> {
    private final String ApiUrl;
    private final UUID SessinKey;
    private final UUID Id;
    private final Integer UserId;

    public GetSongsInAlbumTask(String ApiUrl, UUID SessinKey, Integer UserId, UUID Id) {
        this.ApiUrl = ApiUrl;
    ...
    protected JSONResponse doRoutine() throws Exception {
        return RequestsManager.doGetSongsInAlbumRequest(ApiUrl, SessinKey, UserId, Id);
    }
