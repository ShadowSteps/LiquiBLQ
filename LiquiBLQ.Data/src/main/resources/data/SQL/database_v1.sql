...
(
   ...
   CONSTRAINT "ArtistsPrimariKey" PRIMARY KEY (id)
) 
WITH (
  OIDS = FALSE
)
...
(
   ...
   CONSTRAINT "ArtistAlbumPrimariKey" PRIMARY KEY ("Id"), 
   CONSTRAINT "ArtistForeignKey" FOREIGN KEY ("ArtistId") REFERENCES "Artist" (id) ON UPDATE NO ACTION ON DELETE NO ACTION
) 
WITH (
  OIDS = FALSE
)
...
ALTER TABLE "ArtistAlbum"
  ADD CONSTRAINT "AlbumFk" FOREIGN KEY ("AlbumId") REFERENCES "Album" ("Id")
   ON UPDATE NO ACTION ON DELETE NO ACTION;
CREATE INDEX "fki_AlbumFk"
  ON "ArtistAlbum"("AlbumId");

CREATE TABLE public."SongsInAlbum"
(
   "Id" uuid NOT NULL, 
   "Song" uuid NOT NULL, 
   "Album" uuid NOT NULL, 
   CONSTRAINT "SongsInAlbumPK" PRIMARY KEY ("Id")
) 
WITH (
  OIDS = FALSE
)
...
(
   ...
   "Genre" uuid NOT NULL, 
   "Date" timestamp without time zone NOT NULL, 
   CONSTRAINT "SongPk" PRIMARY KEY ("Id")
) 
WITH (
  OIDS = FALSE
)
...
ALTER TABLE "SongsInAlbum"
  ADD CONSTRAINT "SongFk" FOREIGN KEY ("Album") REFERENCES "Album" ("Id")
   ON UPDATE NO ACTION ON DELETE NO ACTION;
CREATE INDEX "fki_SongFk"
  ON "SongsInAlbum"("Album");

ALTER TABLE "Id"
  RENAME TO "Song";

ALTER TABLE "SongsInAlbum"
  ADD CONSTRAINT "songFk" FOREIGN KEY ("Song") REFERENCES "Song" ("Id")
   ON UPDATE NO ACTION ON DELETE NO ACTION;
CREATE INDEX "fki_songFk"
  ON "SongsInAlbum"("Song");

ALTER TABLE "Song"
  ADD CONSTRAINT "GenreFk" FOREIGN KEY ("Genre") REFERENCES "Genre" ("Id")
   ON UPDATE NO ACTION ON DELETE NO ACTION;
CREATE INDEX "fki_GenreFk"
  ON "Song"("Genre");
